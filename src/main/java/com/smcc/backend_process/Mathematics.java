...
public class Mathematics {
    // Solve Quadratic, linear eq, inequations, add subtract multiply divide hcf lcm sin cos, tan acos, asin, etc.
     ...
     *   "arcsin", "arccos", "arctan" – aliases for asin, acos, atan
     *
     * @param valStr the numeric input (angle in radians or ratio)
     * @param op     the function: sin, cos, tan, asin, acos, atan, arcsin, arccos, or arctan
     */
    public static void solveTrigonometry(String valStr, String op) {
        ...
        switch (op) {
            ...
            case "asin":
            case "arcsin": result = Math.asin(x);  break;
            case "acos":
            case "arccos": result = Math.acos(x);  break;
            case "atan":
            case "arctan": result = Math.atan(x);  break;
            default:
