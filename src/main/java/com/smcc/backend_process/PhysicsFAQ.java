...
public class PhysicsFAQ {
    ...
    private static String youtubeSearch(String topic) {
        String query = topic == null ? "physics" : topic.replace(" ", "+");
        return "For more information, try searching on YouTube: https://www.youtube.com/results?search_query=" + query;
    }

    public static String getDefinition(String topic) {
        if (topic == null) return youtubeSearch(topic);
        String result = topicDefinitions.get(topic.toLowerCase());
        if (result == null) {
    ...
    public static String getDefinitionAndFAQs(String topic) {
        ...
        if (def != null && def.startsWith("For more information") && faqs != null && faqs.startsWith("For more information")) {
            return def;
        } else if (def != null && !def.startsWith("For more information") && faqs != null && !faqs.startsWith("For more information")) {
            return def + "\n\n" + faqs;
        } else if (def != null && !def.startsWith("For more information")) {
            return def;
        } else if (faqs != null && !faqs.startsWith("For more information")) {
            return faqs;
        }
        return youtubeSearch(topic);
    }
